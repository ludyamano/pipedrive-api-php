...
/**
 * Pipedrive Person Fields Methods
 *
 ...
 * PersonFields as a schema for defining the data fields of a Person, it must be kept in mind that some types of
 * custom fields can have additional data fields which are not separate PersonFields per se. Such is the case with
 * monetary, daterange and timerange fields – each of these fields will have one additional data field in addition
 * to the one presented in the context of PersonFields. For example, if there is a monetary field with the key
...
class PersonFields
{
     ...
     * Adds a personField
     *
     * @param  array $data person field detials
     * @return array returns details of the person field
     */
